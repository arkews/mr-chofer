...
const DriverRideDetailsScreen: FC<Props> = ({ navigation }) => {
  ...
  const { mutate: startRide, isLoading: startingRide } =
  ...
  const { mutate: finishRide, isLoading: isEndingRide } =
  ...
  const disableButtons =
    isLoading || startingRide || isEndingRide || isCancelingRide
      ...
      {ride !== undefined && (
        <View className="flex flex-col space-y-5">
          ...
          <View className="flex flex-row justify-between">
            <View className="bg-blue-100 mr-2 px-2.5 py-0.5 rounded border border-blue-400 dark:bg-gray-700 w-min">
              <Text className="text-blue-800 text-xs font-medium dark:text-blue-400">
            ...
            {ride.status === RideStatus.accepted && (
              <View className="flex-1">
                <Pressable
                  ...
                  disabled={disableButtons}
                  className={cn(
                    'text-base px-5 py-3 bg-blue-700 rounded-lg border border-transparent',
                    'active:bg-blue-800',
                    disableButtons &&
                ...
                >
                  <Text className="text-base text-center text-white font-medium">
                    ¡Ya llegue!
                  </Text>
                </Pressable>
              </View>
            ...
            {ride.status === RideStatus.in_progress && (
              <View className="flex-1">
                <Pressable
                  ...
                  disabled={disableButtons}
                  className={cn(
                    'text-base px-5 py-3 bg-green-700 rounded-lg border border-transparent',
                    'active:bg-green-800',
                    disableButtons &&
                      'bg-gray-300 text-gray-700 cursor-not-allowed',
                    disableButtons && 'dark:bg-gray-800 dark:text-gray-400'
